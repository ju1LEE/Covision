      ...
      success(function(data, status, headers, config) {
		...
		$scope.executeWhenReady(function() {
		    ...
		    success(function(data, status, headers, config) {
		        ...
		        $scope.exportDefinitionUrl = "app/rest/activiti/process-definitions/export/" + $routeParams.definitionId + "/" + $scope.definition.key + ".bpmn20.xml"
		        /* covision. exclude decisiontables, forms. 22.1.27. hgsong
