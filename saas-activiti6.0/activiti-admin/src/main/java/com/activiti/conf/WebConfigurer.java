...
import coviflow.converter.CoviConverterManager;
import egovframework.covision.coviflow.util.CoviApplicationContextUtil;
import egovframework.covision.coviflow.util.PropertiesWatcher;
...
public class WebConfigurer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        // for Coviflow initialize. by hgsong.
        CoviApplicationContextUtil.setApplicationContext(rootContext);
        CoviConverterManager.getInstance().init();
        
        
        PropertiesWatcher.getInstance();
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        ...
        PropertiesWatcher.getInstance().close();
    }
}
