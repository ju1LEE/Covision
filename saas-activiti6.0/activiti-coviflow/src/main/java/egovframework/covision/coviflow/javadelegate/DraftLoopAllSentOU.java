/**
 * @Class Name : DraftLoopAllSentOU.java
 * @Description : 
...
public class DraftLoopAllSentOU implements JavaDelegate {

	private static final Logger LOG = LoggerFactory.getLogger(DraftLoopAllSentOU.class);
			
	public void execute(DelegateExecution execution) throws Exception {
		
		LOG.info("DraftLoopAllSentOU");
		...
		try{
			...
			LOG.error("DraftLoopAllSentOU", e);
			throw e;
		}
