/**
 * @Class Name : BasicBypassedExtHandler.java
 * @Description : 
...
public class BasicBypassedExtHandler implements TaskListener {

	private static final Logger LOG = LoggerFactory.getLogger(BasicBypassedExtHandler.class);
	
	@Override
	public void notify(DelegateTask delegateTask) throws Exception{
		
		LOG.info("BypassedExt");
		
		try{
			//Step 1. performer를 할당.
			//LOG.info("BypassedExt performer를 할당");
			...
			LOG.error("BasicBypassedExtHandler", e);
			throw e;
		}
