/**
 * @Class Name : DraftRoutePreIssueDocNo.java
 * @Description : 
...
public class DraftRoutePreIssueDocNo implements JavaDelegate {

	private static final Logger LOG = LoggerFactory.getLogger(DraftRoutePreIssueDocNo.class);

	public void execute(DelegateExecution execution) throws Exception {

		LOG.info("DraftRoutePreIssueDocNo");
		...
		try{
			...
			if (issueDocNumber.equalsIgnoreCase("True") && preIssueDocNum.equalsIgnoreCase("Y")) {
				destination = "DraftPreIssueDocNo";
			} else {
				destination = "DraftRouteLegacyRD";
			}
			...
			LOG.error("DraftRoutePreIssueDocNo", e);
			throw e;
		}
