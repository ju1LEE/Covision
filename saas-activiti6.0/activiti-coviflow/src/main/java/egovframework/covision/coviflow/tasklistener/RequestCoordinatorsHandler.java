/**
 * @Class Name : RequestCoordinatorsHandler.java
 * @Description : 
...
public class RequestCoordinatorsHandler implements TaskListener {

	private static final Logger LOG = LoggerFactory.getLogger(RequestCoordinatorsHandler.class);
	
	@Override
	public void notify(DelegateTask delegateTask) throws Exception{
		
		LOG.info("RequestCoordinators");
		...
		try{
			...
			LOG.error("RequestCoordinatorsHandler", e);
			throw e;
		}
