/**
 * @Class Name : DraftEndRejectedExcutionListener.java
 * @Description : 
...
public class DraftEndRejectedExcutionListener implements ExecutionListener {
	
	private static final Logger LOG = LoggerFactory.getLogger(DraftEndRejectedExcutionListener.class);
	
	public void notify(DelegateExecution execution) throws Exception {
		
		LOG.info("DraftEndRejected");
		...
		try{
			...
			if(basicApprovalResult ==null || !basicApprovalResult.equalsIgnoreCase("cancelled"))
			{
