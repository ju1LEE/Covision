...
public class RequestApproversHandler implements TaskListener {

	private static final Logger LOG = LoggerFactory.getLogger(RequestApproversHandler.class);
	...
	public void notify(DelegateTask delegateTask) throws Exception{
		...
		try{
			...
			LOG.error("RequestApproversHandler", e);
			throw e;
		}
