/**
 * @Class Name : DraftSentBoxHandler.java
 * @Description : 
...
public class DraftSentBoxHandler implements TaskListener {

	private static final Logger LOG = LoggerFactory.getLogger(DraftSentBoxHandler.class);
	
	@Override
	public void notify(DelegateTask delegateTask) throws Exception{
		
		LOG.info("DraftSentBox");
		
		try{
			JSONParser parser = new JSONParser();
			//Step 1. performer, workitem을 할당.
			//insert vrole member
			String ctx = (String)delegateTask.getVariable("g_context");
			...
			LOG.error("DraftSentBoxHandler", e);
			throw e;
		}
