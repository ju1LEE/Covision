/**
 * @Class Name : BasicSharerHandler.java
 * @Description : 
...
public class BasicSharerHandler implements TaskListener {

	private static final Logger LOG = LoggerFactory.getLogger(BasicSharerHandler.class);
	
	@Override
	public void notify(DelegateTask delegateTask) throws Exception{
		
		LOG.info("BasicSharer");
		...
		try{
			...
			LOG.error("BasicSharerHandler", e);
			throw e;
		}
