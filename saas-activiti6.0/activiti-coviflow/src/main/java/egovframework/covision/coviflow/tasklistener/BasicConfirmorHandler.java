/**
 * @Class Name : BasicConfirmorHandler.java
 * @Description : 
...
public class BasicConfirmorHandler implements TaskListener {

	private static final Logger LOG = LoggerFactory.getLogger(BasicConfirmorHandler.class);
	
	@Override
	public void notify(DelegateTask delegateTask) throws Exception{
		
		LOG.info("BasicConfirmor");
		...
		try{
			...
			LOG.error("BasicConfirmorHandler", e);
			throw e;
		}
