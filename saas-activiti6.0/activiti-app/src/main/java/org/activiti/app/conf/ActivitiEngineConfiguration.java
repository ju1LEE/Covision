...
public class ActivitiEngineConfiguration {
    ...
    public ProcessEngineConfigurationImpl processEngineConfiguration() {
    	...
    	processEngineConfiguration.setDatabaseType(environment.getProperty("db"));
    	processEngineConfiguration.setDataSource(dataSource);
    	processEngineConfiguration.setDatabaseSchemaUpdate(environment.getProperty("engine.schema.update", ProcessEngineConfiguration.DB_SCHEMA_UPDATE_FALSE));
    	...
    	formEngineConfiguration.setDatabaseType(environment.getProperty("db"));
    	formEngineConfiguration.setDataSource(dataSource);
    	formEngineConfiguration.setDatabaseSchemaUpdate(environment.getProperty("db.schema.update", FormEngineConfiguration.DB_SCHEMA_UPDATE_FALSE));
    	...
    	dmnEngineConfiguration.setDatabaseType(environment.getProperty("db"));
    	dmnEngineConfiguration.setDataSource(dataSource);
    	dmnEngineConfiguration.setDatabaseSchemaUpdate(environment.getProperty("db.schema.update", DmnEngineConfiguration.DB_SCHEMA_UPDATE_FALSE));
