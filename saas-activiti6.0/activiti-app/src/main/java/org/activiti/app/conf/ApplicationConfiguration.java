...
@Configuration
@PropertySources({
	@PropertySource(value = "file://${DEPLOY_PATH}/covi_property/activiti-app.properties"),
	@PropertySource(value = "file://${DEPLOY_PATH}/covi_property/activiti_db.properties"),
	@PropertySource(value = "file://${DEPLOY_PATH}/covi_property/engine.properties"),
