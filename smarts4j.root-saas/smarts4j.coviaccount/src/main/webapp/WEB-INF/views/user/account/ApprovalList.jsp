	...
	function setGridConfig(){
		...
		if(g_mode == "Approval"){ //미결함 - 읽은 게시글은 style : font-weight를 사용하여 굵게 표시 하도록 분리
			                  ...
			                  {key:'FormSubject', label:'<spring:message code="Cache.lbl_apv_subject"/>', width:'250', align:'left',showExcel:true,			    // 제목
							   	  formatter:function () {		
										...
										InitiatorName = "<div class=\"btnFlowerName\" onclick=\"coviCtrl.setFlowerName(this)\" style=\"position:relative; cursor:pointer;\" data-user-code=\""+this.item.InitiatorID+"\" data-user-mail>" + InitiatorName + "</div>";
						   				...
						   				html += "</div><ui class=\"listinfo\"><li>"+ this.item.SubKind  +" </li><li>"+ InitiatorName + "</li><li>"+ this.item.InitiatorUnitName +"</li><li>"+ getStringDateToString("yyyy.MM.dd HH:mm:ss",this.item.Created)  +"</li><li>"+ CFN_GetDicInfo(this.item.FormName)  +"</li><li class=\"poRela\"><span class=\"usa\" style=\"display: none;\">유사양식</span></li></ul>";
			                  ...
			                  {key:'FormSubject', label:'<spring:message code="Cache.lbl_apv_subject"/>', width:'250', align:'left',showExcel:true,						    // 제목
							   	  formatter:function () {
										...
										InitiatorName = "<div class=\"btnFlowerName\" onclick=\"coviCtrl.setFlowerName(this)\" style=\"position:relative; cursor:pointer;\" data-user-code=\""+this.item.InitiatorID+"\" data-user-mail>" + InitiatorName + "</div>";
						   				...
						   				html += "</div><ui class=\"listinfo\"><li>"+ this.item.SubKind  +" </li><li>"+ InitiatorName  +"</li><li>"+ CFN_GetDicInfo(this.item.InitiatorUnitName) +"</li><li>"+ getStringDateToString("yyyy.MM.dd HH:mm:ss",g_mode=="PreApproval"?this.item.Created:this.item.Finished) +"</li><li>"+ CFN_GetDicInfo(this.item.FormName) +"</li><li>"+currentTarget+"</li><li class=\"poRela\"><span class=\"usa\" style=\"display: none;\">유사양식</span></li></ul>";		
			 ...
			 headerData =[
						  ...
						  {key:'EndDate', label:'<spring:message code="Cache.lbl_RepeateDate"/>',  width:'60', align:'center', sort:'desc',showExcel:true, 
		                	  formatter:function () {
