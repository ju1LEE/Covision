...
define({
    ...
    DateConversionFormat: [
        ...
        'mmm-yy', // m-yy(yy),
        'm/d/yyyy', // yyyy-mm-dd, yy-mm-dd(x)

        // yyyy-mm-dd h:m(:s AM/PM), mm-dd-yyyy h:m(:s AM/PM)
        // m-d h:m(:s AM/PM), mmm-d h:m(:s AM/PM), mmmm-d h:m(:s AM/PM), d-mmm h:m(:s AM/PM), d-mmmm h:m(:s AM/PM), d-m h:m(:s AM/PM)(x)
        // m-d-yy(yy) h:m(:s AM/PM), mmm-d-yy(yy) h:m(:s AM/PM), mmmm-d-yy(yy) h:m(:s AM/PM), d-mmm-yy(yy) h:m(:s AM/PM), d-mmmm-yy(yy) h:m(:s AM/PM), d-m-yy(yy) h:m(:s AM/PM)
        // m-yy(yy) h:m(:s AM/PM) ...
        'm/d/yyyy h:mm'
    ],
