...
G_keditorResizeBackDiv:null,G_isResize:!1,G_isDrag:!1,G_firstDrag:!1,G_checkTagName:",img,iframe,td,th,table,embed,div,video,",G_deleteCheckTagName:",table,video,",G_mouseOveriframeObj:null,G_keditorIframeOverDiv:null,G_startX:0,G_startY:0,G_dragX:0,G_dragY:0,G_lastDragX:0,G_lastDragY:0,G_orgEnterTag:"",G_ie8Bug:!1,keyDownEvt:null,G_keditorResize_elem_Rect:null,G_UseMouseTableInoutdent:!1,G_ImageR:1},a;for(a in b)this[a]=b[a]}
...
"td"==e||"th"==e?GetParentbyTagName(d,"table"):d;if("table"==f.tagName.toLowerCase()&&checkNoResizeTable(f))return;"IMG"==f.tagName&&"FIGURE"==f.parentNode.tagName&&(f=f.parentNode);if(G_keditorResize_elem==f||G_keditorResize_OverElem==f)return;G_keditorResize_OverElem=f;if("div"==G_keditorResize_OverElem.tagName.toLowerCase()&&"div"==_iframeDoc.activeElement.tagName.toLowerCase())return;setResizeIcon();KEDITORTOP.RAONKEDITOR.util.addEvent(G_keditorResize_OverElem,"mouseout",ResizeElmOutEvt)}else{var m=
GetParentbyTagName(d,"table"),h=GetParentbyTagName(d,"div");if(m||h){m&&h?G_keditorResize_OverElem=GetParentbyTagName(h,"table")?h:m:m?G_keditorResize_OverElem=m:h&&(G_keditorResize_OverElem=h);if("div"==G_keditorResize_OverElem.tagName.toLowerCase()&&"div"==_iframeDoc.activeElement.tagName.toLowerCase())return;if("table"==G_keditorResize_OverElem.tagName.toLowerCase()&&checkNoResizeTable(G_keditorResize_OverElem)){G_keditorResize_OverElem=null;return}if("div"==G_keditorResize_OverElem.tagName.toLowerCase()&&
(-1<G_keditorResize_OverElem.className.indexOf("keditor_Page_Break")||""!=a._config.dragResizeApplyDivClass&&(g=","+a._config.dragResizeApplyDivClass+",",0>g.indexOf(","+G_keditorResize_OverElem.className+","))))return;setResizeIcon();KEDITORTOP.RAONKEDITOR.util.addEvent(G_keditorResize_OverElem,"mouseout",ResizeElmOutEvt)}}}catch(n){}}};
...
"mouseup",function(a){getFirstRange();null!=KEDITORTOP.G_CURRKEDITOR._LastRange&&restoreSelection(null,!0);G_REMOVE_dragResizeIcon=!1;var b=G_keditorResize_OverElem;KEDITORTOP.G_CURRKEDITOR._config.useMouseTableInoutdent&&(G_keditorResize_elem_Rect=getClientRect(b),G_UseMouseTableInoutdent="TABLE"==b.nodeName?!0:!1);resizeHandleClear();G_keditorResize_elem=b;clearInterval(dragResizeIconInterval);setResizeHandle(a,!0);G_CURSOR_ELEMENT=b;"img"==b.nodeName.toLowerCase()&&(G_keditorResize_Elem_Flag=!0);
KEDITORTOP.RAONKEDITOR.browser.ie&&9>KEDITORTOP.RAONKEDITOR.browser.ieVersion&&stopDragElem()}),KEDITORTOP.RAONKEDITOR.util.addEvent(G_keditorResizeIcon,"dragstart",function(a){G_REMOVE_dragResizeIcon=!0;G_keditorResizeIcon.parentNode&&(G_keditorResizeIcon.parentNode.removeChild(G_keditorResizeIcon),clearIfameOverDiv());G_keditorResizeIcon=null;clearInterval(dragResizeIconInterval);dragResizeIconInterval=null;!KEDITORTOP.RAONKEDITOR.browser.ie||9<KEDITORTOP.RAONKEDITOR.browser.ieVersion?dragMoveStart(a,
G_keditorResize_OverElem):KEDITORTOP.RAONKEDITOR.util.cancelEvent(a)})),G_keditorResizeIcon){G_REMOVE_dragResizeIcon=!1;var b=getElementOffset(_iframeWin.frameElement),a=getClientRect(G_keditorResize_OverElem);G_keditorResizeIcon.style.left=b.left+a.left+"px";G_keditorResizeIcon.style.top=b.top+(a.top-13)+"px"}}catch(c){}};
...
keditorDragResize.prototype.ifameOverDivClick=function(b){with(KEDITORTOP.G_CURRKEDITOR.keditor_dragresize)try{var a=G_mouseOveriframeObj;resizeHandleClear();G_keditorResize_OverElem=null;G_keditorResize_elem=a;clearInterval(dragResizeIconInterval);setResizeHandle(b,!0);KEDITORTOP.RAONKEDITOR.browser.ie||setTimeout(function(){restoreSelection(saveSelection(KEDITORTOP.G_CURRKEDITOR.ID,!0),!0)},0)}catch(c){}};
...
(d.style.left=e.left+g.left-G_keditorResizeDivBorder+"px");d.style.top=G_UseMouseTableInoutdent?e.top+G_keditorResize_elem_Rect.top-G_keditorResizeDivBorder+"px":e.top+g.top-G_keditorResizeDivBorder+"px";this.setDragResizeDivSize(d);this.setDragResizeDivPosition(d);G_keditorResizeHandleHolder=_iframeDoc.createElement("div");G_keditorResizeHandleHolder.unSelectable="on";for(e=0;e<handles.length;e++){var f=document.createElement("div");f.className=resizeName+" "+resizeName+"-"+handles[e];f.unSelectable=
"on";G_keditorResizeHandleHolder.appendChild(f);G_keditorResizeHandleHolder[handles[e]]=f}setHandlePosition();var m=getEditorFrameDoc(KEDITORTOP.G_CURRKEDITOR);m.body.appendChild(G_keditorResizeHandleHolder);f=document.createElement("div");f.className="K_Editor_drag_resizeinfo";f.style.position="absolute";f.style.fontSize="11px";f.style.display="none";f.unSelectable=!0;var h=document.createElement("span");f.appendChild(h);G_keditorResizeHandleHolder.appendChild(f);G_keditorResizeHandleHolder.keditor_resizeinfo=
f;G_keditorResizeEditElem&&(KEDITORTOP.G_CURRKEDITOR._config.enterTag=G_orgEnterTag,G_keditorResizeEditElem=null);if(G_keditorResize_elem.isContentEditable&&-1<G_editIconTagName.indexOf(","+G_keditorResize_elem.tagName.toLowerCase()+",")){var n=_iframeDoc.createElement("img");n.id="keditorResizeEditIcon";n.src=G_keditorResizeEditIconSrc;n.style.zIndex=99999999;n.style.position="absolute";n.style.cursor="pointer";n.style.right="0px";n.style.top="0px";d.appendChild(n);G_keditorResizeEditIcon=n}m=getEditorFrameDoc(KEDITORTOP.G_CURRKEDITOR);
m.body.appendChild(d);G_keditorResizeDiv=d;d="keditorResize";var q=G_keditorResize_elem.tagName.toLowerCase();if("img"==q){var l,k;if(-1<G_keditorResize_elem.style.width.indexOf("%")||-1<G_keditorResize_elem.style.height.indexOf("%")){var p=getClientRect(G_keditorResize_elem);l=p.right-p.left;k=p.bottom-p.top}else""!=G_keditorResize_elem.style.width?l=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(G_keditorResize_elem.style.width):(p=getClientRect(G_keditorResize_elem),l=p.right-p.left),""!=G_keditorResize_elem.style.height?
k=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(G_keditorResize_elem.style.height):(p=getClientRect(G_keditorResize_elem),k=p.bottom-p.top);G_ImageR=1*l/k;KEDITORTOP.RAONKEDITOR.G_SELECTED_IMAGE_ELEMENT=G_keditorResize_elem;d=GetParentbyTagName(G_keditorResize_elem,"figure")?"focusFigure":"focusImage"}else"table"==q&&(d="focusTable");KEDITORTOP.G_CURRKEDITOR._iconEnable(d);KEDITORTOP.RAONKEDITOR.util.removeEvent(G_keditorResizeDiv,"keydown",keyDown);KEDITORTOP.RAONKEDITOR.util.addEvent(G_keditorResizeDiv,
"mousedown",startDragElem);KEDITORTOP.RAONKEDITOR.util.addEvent(G_keditorResizeHandleHolder,"mousedown",startDragElem)}a&&startDragElem(b,c)}catch(A){}};
...
keditorDragResize.prototype.startDragElem=function(b,a){with(KEDITORTOP.G_CURRKEDITOR.keditor_dragresize)try{var c=b.target||b.srcElement,d=new RegExp(resizeName+"-([trmbl]{2})","");if(isRightClick(b)){G_keditorResize_elem&&(c=G_keditorResize_elem);resizeHandleClear();var e=c.tagName.toLowerCase();if("img"==e)selection(c);else if("table"==e){G_keditorResize_showContext=!1;var g=getFirstRange();g.sel.removeAllRanges();setTimeout(function(){doSetCaretPosition(getMyFirstOrLastChildElementNode(c),0)},
1)}return}if(c==G_keditorResizeEditIcon){c=G_keditorResize_elem;resizeHandleClear();g=getFirstRange();g.sel.removeAllRanges();"table"==c.tagName.toLowerCase()?(c=getMyFirstOrLastChildElementNode(c),doSetCaretPosition(c,0)):"div"==c.tagName.toLowerCase()&&(G_orgEnterTag=KEDITORTOP.G_CURRKEDITOR._config.enterTag,KEDITORTOP.G_CURRKEDITOR._config.enterTag="br",G_keditorResizeEditElem=c,doSetCaretPosition(c,0));KEDITORTOP.RAONKEDITOR.util.cancelEvent(b);return}if(d.test(c.className))elmX=parseInt(G_keditorResize_elem.style.left),
elmY=parseInt(G_keditorResize_elem.style.top),elmW=G_keditorResize_elem.offsetWidth,elmH=G_keditorResize_elem.offsetHeight,G_firstDrag=G_isResize=!0,iframeDocLastMouseY=iframeDocLastMouseX=lastMouseY=lastMouseX=0,handle=c;else{if(G_keditorResize_elem&&"TABLE"!=G_keditorResize_elem.nodeName&&(G_UseMouseTableInoutdent=!1,"IMG"==G_keditorResize_elem.nodeName&&"FIGURE"==G_keditorResize_elem.parentNode.tagName)){KEDITORTOP.RAONKEDITOR.util.cancelEvent(b);return}if("1"==KEDITORTOP.G_CURRKEDITOR._config.dragResizeMovable||
G_UseMouseTableInoutdent||"absolute"==G_keditorResize_elem.style.position.toLowerCase())G_isDrag=!0;else if(c.id&&"keditorResizeIcon"==c.id){KEDITORTOP.RAONKEDITOR.util.cancelEvent(b);return}G_firstDrag=!0;G_lastDragY=G_lastDragX=G_dragY=G_dragX=0}KEDITORTOP.G_CURRKEDITOR.keditor_dragresize.preventScrollMove();G_REMOVE_dragResizeIcon=!1;clearInterval(dragResizeIconInterval);clearIfameOverDiv();d=_iframeWin;b||(b=d.event);offsetX=b.clientX;offsetY=b.clientY;G_keditorResizeDiv.style.left||(G_keditorResizeDiv.style.left=
"0px");G_keditorResizeDiv.style.top||(G_keditorResizeDiv.style.top="0px");("1"==KEDITORTOP.G_CURRKEDITOR._config.dragResizeMovable||G_UseMouseTableInoutdent||"absolute"==G_keditorResize_elem.style.position.toLowerCase()||G_isResize)&&setKeditorResizeBackDiv();var f=getElementOffset(_iframeWin.frameElement);"doc"!=a&&(f.left=0,f.top=0);G_startX=G_UseMouseTableInoutdent?""==G_keditorResize_elem.style.marginLeft?0:parseInt(G_keditorResize_elem.style.marginLeft):parseInt(G_keditorResizeDiv.style.left)+
G_keditorResizeDivBorder-f.left;G_startY=parseInt(G_keditorResizeDiv.style.top)+G_keditorResizeDivBorder-f.top;set_ruler_vertical_height(KEDITORTOP.G_CURRKEDITOR);KEDITORTOP.RAONKEDITOR.util.addEvent(G_keditorResizeBackDiv,"mousemove",dragElem);KEDITORTOP.RAONKEDITOR.util.addEvent(document,"mouseup",stopDragElem);onResize({cmd:"start"});KEDITORTOP.RAONKEDITOR.util.cancelEvent(b)}catch(m){}};
...
(G_keditorResizeIcon.style.left=d+"px",G_keditorResizeIcon.style.top=e-13+"px");var m=getClientRect(_iframeWin.frameElement),h=getWindowScrollPos(_iframeWin);0==G_UseMouseTableInoutdent&&(isNaN(parseInt(G_keditorResize_elem.style.left,10))&&(G_keditorResize_elem.style.left=d-m.left+h[0]-getClientRect(G_keditorResize_elem).left+"px"),isNaN(parseInt(G_keditorResize_elem.style.top,10))&&(G_keditorResize_elem.style.top=e-m.top+h[1]-getClientRect(G_keditorResize_elem).top+"px"));var n=getParentPosition();
if(G_UseMouseTableInoutdent){var q=d-m.left-n.left;0>q&&(q=-1);if("1"==KEDITORTOP.G_CURRKEDITOR._config.limitTableInoutdent){var c=0,l=getClientRect(G_keditorResize_elem);if(""!=_iframeDoc.body.style.width&&-1<_iframeDoc.body.style.width.indexOf("px"))c=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(_iframeDoc.body.style.width);else{c=_iframeDoc.documentElement.clientWidth;if(0==c||null==c||void 0==c)c=_iframeDoc.body.clientWidth;c=Math.floor(c);c-=20}if(0<c){var k=c-(l.right-l.left);0>k&&(k=0);G_keditorResize_elem.style.marginLeft=
q<=k?q+1+"px":k+"px"}else G_keditorResize_elem.style.marginLeft=q+1+"px"}else G_keditorResize_elem.style.marginLeft=q+1+"px"}else G_keditorResize_elem.style.left=d-m.left+h[0]-n.left+"px",G_keditorResize_elem.style.top=e-m.top+h[1]-n.top+"px";setHandlePosition()}KEDITORTOP.RAONKEDITOR.util.stopEvent(b);KEDITORTOP.RAONKEDITOR.util.cancelEvent(b)}catch(p){}};
...
G_firstDrag=G_isDrag=G_ie8Bug=!1;G_keditorResizeIcon&&G_keditorResizeIcon.parentNode&&(G_keditorResizeIcon.parentNode.removeChild(G_keditorResizeIcon),G_keditorResizeIcon=null);dragResizeIconInterval&&(clearInterval(dragResizeIconInterval),dragResizeIconInterval=null);G_keditorResize_OverElem&&(KEDITORTOP.RAONKEDITOR.util.removeEvent(G_keditorResize_OverElem,"mouseout",ResizeElmOutEvt),"FIGURE"==G_keditorResize_OverElem.nodeName&&0==G_isResize&&removeKeditorResizeDiv());KEDITORTOP.RAONKEDITOR.util.removeEvent(document,
"mouseup",stopDragElem);removeKeditorResizeBackDiv();set_ruler_vertical_height(KEDITORTOP.G_CURRKEDITOR)}catch(a){}};
...
KEDITORTOP.G_CURRKEDITOR.UndoManager.putUndo(),G_firstDrag=!1);var e=!1;if(this.resizeHandleDrag&&this.resizeHandleDrag(c,d))e=!0;else{var g=c,f=d;elmX+g<minLeft?mOffX=g-(c=minLeft-elmX):elmX+elmW+g>maxLeft&&(mOffX=g-(c=maxLeft-elmX-elmW));elmY+f<minTop?mOffY=f-(d=minTop-elmY):elmY+elmH+f>maxTop&&(mOffY=f-(d=maxTop-elmY-elmH));elmX+=c;elmY+=d}if(e){var m=getElementBorderWidth(),h=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(m.borderTopWidth)+KEDITORTOP.RAONKEDITOR.util.parseIntOr0(m.borderBottomWidth),
n=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(G_keditorResize_elem.style.paddingTop)+KEDITORTOP.RAONKEDITOR.util.parseIntOr0(G_keditorResize_elem.style.paddingBottom),q=G_keditorResize_elem.style.height,l,e=0;if(-1<G_keditorResize_elem.style.width.indexOf("%")||-1<q.indexOf("%")){var k=getClientRect(G_keditorResize_elem);l=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(k.right-k.left);e=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(k.bottom-k.top)}else if(l=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(G_keditorResize_elem.style.width,
10),e=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(G_keditorResize_elem.style.height,10),0==l||0==e)k=getClientRect(G_keditorResize_elem),0==l&&(l=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(k.right-k.left)),0==e&&(e=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(k.bottom-k.top));var p=handle&&handle.className&&handle.className.match(new RegExp(resizeName+"-([tmblr]{2})"))?RegExp.$1:"";if("IMG"==G_keditorResize_elem.tagName&&(-1<p.indexOf("br")||-1<p.indexOf("bl")||-1<p.indexOf("tl")||-1<p.indexOf("tr")))l=parseInt(elmW,
10)-(h+n),setNodeWidthHeight(G_keditorResize_elem,{width:l+"px",height:KEDITORTOP.RAONKEDITOR.util.parseIntOr0(1*l/G_ImageR)+"px"});else{if(0<=p.indexOf("l")||0<=p.indexOf("r"))l=parseInt(elmW,10)-(h+n),setNodeWidthHeight(G_keditorResize_elem,{width:l+"px"}),""!=G_keditorResize_elem.style.height||!G_keditorResize_elem.getAttribute("height")&&""!=G_keditorResize_elem.getAttribute("height")||setNodeWidthHeight(G_keditorResize_elem,{height:e+"px"});if(0<=p.indexOf("t")||0<=p.indexOf("b"))e=parseInt(elmH,
10)-(h+n),setNodeWidthHeight(G_keditorResize_elem,{height:e+"px"}),""!=G_keditorResize_elem.style.width||!G_keditorResize_elem.getAttribute("width")&&""!=G_keditorResize_elem.getAttribute("width")||setNodeWidthHeight(G_keditorResize_elem,{width:l+"px"})}"1"==KEDITORTOP.G_CURRKEDITOR._config.dragResizeMovable&&(G_keditorResize_elem.style.left=parseInt(elmX,10)+"px",G_keditorResize_elem.style.top=parseInt(elmY,10)+"px");h=!1;if("table"==G_keditorResize_elem.tagName.toLowerCase()){var h=!0,n=G_keditorResize_elem,
A=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(G_keditorResize_elem.style.width,10),B=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(G_keditorResize_elem.style.height,10),q=0,y=n.rows.length;for(l=0;l<y;l++)var t=n.rows[l],q=q+parseFloat(t.cells[0].style.height.replace("px",""));for(l=0;l<y;l++){for(var t=n.rows[l],v=t.cells.length,k=e=0;k<v;k++)var r=t.cells[k],e=e+parseFloat(r.style.width.replace("px",""));if((0<=p.indexOf("l")||0<=p.indexOf("r"))&&A!=e)for(e=(e-A)/v,k=0;k<v;k++){var r=t.cells[k],E=Math.floor(100*
parseFloat(parseFloat(r.style.width.replace("px",""))-e+parseFloat(c/v)))/100;r.style.width=E+"px"}if((0<=p.indexOf("t")||0<=p.indexOf("b"))&&B!=q)for(e=(q-B)/y,k=0;k<v;k++){var r=t.cells[k],F=Math.floor(100*parseFloat(parseFloat(r.style.height.replace("px",""))-e+parseFloat(d/y)))/100;r.style.height=F+"px"}}}setHandlePosition();G_keditorResizeHandleHolder.keditor_resizeinfo.style.display="";G_keditorResizeHandleHolder.keditor_resizeinfo.style.zIndex=1E6;G_keditorResizeHandleHolder.keditor_resizeinfo.style.top=
handle.offsetTop+"px";G_keditorResizeHandleHolder.keditor_resizeinfo.style.left=handle.offsetLeft+"px";G_keditorResizeHandleHolder.keditor_resizeinfo.firstChild&&G_keditorResizeHandleHolder.keditor_resizeinfo.removeChild(G_keditorResizeHandleHolder.keditor_resizeinfo.firstChild);var C=document.createElement("span"),z=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(getNodeWidthHeight(G_keditorResize_elem,"width"),10),u=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(getNodeWidthHeight(G_keditorResize_elem,"height"),
10);if(7!=KEDITORTOP.RAONKEDITOR.browser.ieVersion&&"video"!=G_keditorResize_elem.tagName.toLowerCase()){var w=getNodeWidthHeight(G_keditorResize_elem,"maxWidth");""!=w&&(w=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(w,10),z=z>w?w:z);var x=getNodeWidthHeight(G_keditorResize_elem,"maxHeight");""==x||h||(x=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(x,10),u=u>x?x:u)}if(0==u)var D=getClientRect(G_keditorResize_elem),u=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(D.bottom-D.top);C.innerHTML=z+" X "+u;G_keditorResizeHandleHolder.keditor_resizeinfo.appendChild(C)}G_keditorResizeDiv&&
(this.setDragResizeDivPosition(G_keditorResizeDiv),this.setDragResizeDivSize(G_keditorResizeDiv));KEDITORTOP.RAONKEDITOR.util.cancelEvent(b)}catch(G){}};
...
mOffX=e-(b=elmW-minWidth):elmX+e<minLeft&&(mOffX=e-(b=minLeft-elmX)),elmX+=b,elmW-=b,g=!0);0<=c.indexOf("r")&&(rs=1,elmW+e<minWidth?mOffX=e-(b=minWidth-elmW):elmX+elmW+e>maxLeft&&(mOffX=e-(b=maxLeft-elmX-elmW)),elmW+=b,g=!0);return g}catch(f){}};
keditorDragResize.prototype.mouseUp=function(b){with(this)try{if(isRightClick(b)||checkClickOnScrollBar(b)||KEDITORTOP.G_CURRKEDITOR.isMouseDownOnScrollBar)return;var a=!0;try{if(0==G_isResize){var c=b.target?b.target:b.srcElement;if(c){var d=null,e=null;9!=c.nodeType&&(d=c.ownerDocument);(e=getDocWindow(d).frameElement)?0!=e.id.indexOf("raonk_frame_")&&0!=e.id.indexOf("keditor_design_")&&(a=!1):a=!1}}}catch(g){}if(0==a){resizeHandleClear();return}if(G_keditorResize_elem&&"img"==G_keditorResize_elem.tagName.toLowerCase()&&
"absolute"!=G_keditorResize_elem.style.position){var f,m;if(-1<G_keditorResize_elem.style.width.indexOf("%")||-1<G_keditorResize_elem.style.height.indexOf("%")){var h=getClientRect(G_keditorResize_elem);f=h.right-h.left;m=h.bottom-h.top}else""!=G_keditorResize_elem.style.width?f=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(G_keditorResize_elem.style.width):(h=getClientRect(G_keditorResize_elem),f=h.right-h.left),""!=G_keditorResize_elem.style.height?m=KEDITORTOP.RAONKEDITOR.util.parseIntOr0(G_keditorResize_elem.style.height):
(h=getClientRect(G_keditorResize_elem),m=h.bottom-h.top);G_ImageR=1*f/m;try{var n=G_keditorResize_elem.parentNode;if(!KEDITORTOP.RAONKEDITOR.browser.chrome&&!KEDITORTOP.RAONKEDITOR.browser.opera){if(G_keditorResize_elem.parentNode.tagName&&"figure"==G_keditorResize_elem.parentNode.tagName.toLowerCase()){var q=G_keditorResize_elem.parentNode.getElementsByTagName("figcaption");q&&q[0]&&(n=getMyFirstOrLastChildElementNode(q[0]),rangy.getSelection(_iframeWin).removeAllRanges(),doSetCaretPosition(n,0))}KEDITORTOP.RAONKEDITOR.browser.ie&&
9>KEDITORTOP.RAONKEDITOR.browser.ieVersion&&(KEDITORTOP.G_CURRKEDITOR.keditor_dragresize.preventScrollMove(),doSetCaretPosition(n,0))}}catch(l){}}G_keditorResize_elem.getAttribute("raon_chart")&&G_keditorResize_elem.setAttribute("raon_plugin","chart");onChange({editor:KEDITORTOP.G_CURRKEDITOR,isPossibleDirty:!0});stopDragElem();KEDITORTOP.G_CURRKEDITOR.keditor_dragresize.removePreventScrollMove();onResize({cmd:"end",event:b,target:G_keditorResize_elem,isResize:G_isResize});deselect(!1);G_isResize=
!1;if("1"==KEDITORTOP.G_CURRKEDITOR._config.returnEvent.mouse_event)try{if(a={strEventName:"mouseup",objEvent:b,objElement:G_keditorResize_elem},!1===("function"==typeof KEDITORTOP.G_CURRKEDITOR._config.event.mouse?KEDITORTOP.G_CURRKEDITOR._config.event.mouse(KEDITORTOP.G_CURRKEDITOR.ID,a):KEDITORTOP.KEDITORWIN.RAONKEDITOR_MouseEvent(KEDITORTOP.G_CURRKEDITOR.ID,a))){KEDITORTOP.RAONKEDITOR.util.cancelEvent(b);return}}catch(k){}docMouseY=docMouseX=topMouseY=topMouseX=null}catch(p){}};
...
"px")}setHandlePosition();KEDITORTOP.RAONKEDITOR.util.cancelEvent(b);return}resizeHandleClear()}else if(c&&(86==d||65==d||88==d||67==d)||46==d||8==d){resizeHandleClear();var e=a.tagName.toLowerCase();if((46==d||8==d)&&-1<G_deleteCheckTagName.indexOf(","+e+",")){if("table"!=e){KEDITORTOP.RAONKEDITOR.util.cancelEvent(b);var g=getFirstRange().sel,f=getFirstRange().range;f.setStartBefore(a);f.setEndBefore(a);g.removeAllRanges();g.addRange(f)}a.parentNode.removeChild(a)}else{if("img"==e){var m=GetParentbyTagName(a,
"figure");if(m&&(a=m,46==d||8==d)){a.parentNode.removeChild(a);KEDITORTOP.RAONKEDITOR.util.cancelEvent(b);return}}selection(a)}}else(c&&90==d||89==d||!c)&&resizeHandleClear();removePreventScrollMove()}catch(h){}};
