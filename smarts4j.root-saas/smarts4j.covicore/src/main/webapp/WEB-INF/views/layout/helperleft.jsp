...
var fnTreeObj = {
	pageStart: function(){
		...
		var List = [
			{no:1, nodeName:"기본정보조회", writer:"tom", type:"0", pno:0},
			{no:2, nodeName:"AxisJ", writer:"tom", type:"0", pno:0},
			{no:3, nodeName:"암복호화관리", writer:"tom", type:"0", pno:0},
			{no:4, nodeName:"결재컴포넌트", writer:"tom", type:"0", pno:0},
			{no:5, nodeName:"API", writer:"tom", type:"0", pno:0},
			{no:6, nodeName:"배포관리", writer:"tom", type:"0", pno:0}
		];
		myTree.setList(List);
	},
	tree1: function(){
