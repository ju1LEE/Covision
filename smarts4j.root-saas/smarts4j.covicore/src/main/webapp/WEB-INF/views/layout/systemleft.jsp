...
var fnTreeObj = {
	pageStart: function(){
		...
		var List = [
			{no:1, nodeName:"다국어관리", writer:"tom", type:"0", pno:0},
			{no:2, nodeName:"기초설정관리", writer:"tom", type:"0", pno:0},
			{no:3, nodeName:"프로그램관리", writer:"tom", type:"0", pno:0},
			{no:4, nodeName:"타임존관리", writer:"tom", type:"0", pno:0},
			{no:5, nodeName:"스토리지정보관리", writer:"tom", type:"0", pno:0},
			{no:6, nodeName:"접속Agent관리", writer:"tom", type:"0", pno:0}
		];
		myTree.setList(List);
	},
	tree1: function(){
