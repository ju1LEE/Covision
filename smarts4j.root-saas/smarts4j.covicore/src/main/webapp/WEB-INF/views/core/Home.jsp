...
<script>
	function callACLPop(){
		CFN_OpenWindow("control/callacl.do?lang=en&allowedACL=_____V_&orgMapCallback=orgCallback&aclCallback=aclCallback","권한지정",1000,580,"");
	}
	...
	function callDicPop(){
		...
		CFN_OpenWindow(url,"권한지정",1000,580,"");
	}
