...
doButtonCase['btSave'] = function (oBtn, oVar) {//임시저장
    if (document.getElementById("Subject").value == "") {
        var subject = mobile_comm_getDicInfo(getInfo("AppInfo.usnm_multi")) + " - " + getInfo("FormInfo.FormName");
	            ...
	            if (!bEdit) {
	                if (bDisplayOnly) {
	                	docDiv.append(mobile_approval_replaceCharacter(docItem.subject));
	               	 	...
	               	 	docDiv
	               	 		.append($("<span>", {"class" : "txt_gn11_blur","onmouseover":'this.style.color=\"#2f71ba\"', "onmouseout" : 'this.style.color=\"#111111\"', "style" : 'cursor:pointer;', "onClick" : "mobile_approval_openDocLink('"+url+"')"})
