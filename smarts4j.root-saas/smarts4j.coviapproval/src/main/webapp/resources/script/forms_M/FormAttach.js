...
function formDisplaySetFileInfo() {
	...
	if((getInfo("FileInfos") == "" || getInfo("FileInfos") == "[]")
			&& formJson && formJson.FormInstanceInfo && formJson.FormInstanceInfo.AttachFileInfo && formJson.FormInstanceInfo.AttachFileInfo.FileInfos) setInfo("FileInfos",JSON.stringify(formJson.FormInstanceInfo.AttachFileInfo.FileInfos));
