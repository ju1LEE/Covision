        ...
        if (formJson.Request.mode == "DRAFT" || formJson.Request.mode == "TEMPSAVE") {
            ...
            $.ajax({
                ...
                ,success : function (data) {
                	$("#EnterDate").val( data.list[0].EnterDate );
                    $("#Title").val( data.list[0].JobLevelName + " / " + data.list[0].JobTitleName);
                }
            });
            ...
            $.ajax({
                ...
                ,success : function (data) {
                    ...
                    $("#Dept").val(memberOfName + " / " + deptName);
                }
            });
            
            //제목설정
            var formTitle = "[사직서]";
            $("#Subject").val(formTitle + " " + memberOfName + " " + deptName + " " + Common.getSession('UR_Name'));
        }
