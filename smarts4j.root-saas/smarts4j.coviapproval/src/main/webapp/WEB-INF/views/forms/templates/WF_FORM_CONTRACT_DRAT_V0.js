...
function postRenderingForTemplate() {
    ...
    if (getInfo("Request.templatemode") == "Read") {
        ...
        document.getElementById("Subject").value = getInfo("FormInstanceInfo.Subject")==undefined? "" :getInfo("FormInstanceInfo.Subject");
...
//getInfo("mode") == "DRAFT" || getInfo("mode") == "TEMPSAVE" 인 경우
//setFormInfoDraft -> setBodyContext로 순으로...
