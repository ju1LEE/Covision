...
function postRenderingForTemplate() {
    ...
    if (getInfo("Request.templatemode") == "Read") {
        ...
        if (formJson.Request.mode == "DRAFT") {
            ...
            document.getElementById("Subject").value = "소프트웨어 라이선스 사용 인증서";
			 $('#Contract_Name').focus(function () {
                document.getElementById("Subject").value = "";
                document.getElementById("Subject").value = "소프트웨어 라이선스 사용 인증서 -" + document.getElementById("Customer_Name").value;
            });
