...
/**
 * 집행계획 월별공수 상세팝업의 표시/비표시 처리
 */
function popMonthlyDetail() {
    if ($('#divBizmntMonthlyDetail').css('display') == 'none') {
        document.getElementById("divBizmntMonthlyDetail").style.display = 'inline';
    } else {
    	document.getElementById("divBizmntMonthlyDetail").style.display = 'none';
    }
}
