...
function postRenderingForTemplate() {
    ...
    if((Common.getBaseConfig("ExtenStartTime") != "" && Common.getBaseConfig("ExtenEndTime") != "" && Common.getBaseConfig("ExtenUnit") != "0") || (Common.getBaseConfig("ExtenStartTime") != "0000" && Common.getBaseConfig("ExtenEndTime") != "0000" && Common.getBaseConfig("ExtenUnit") != "0")){ 
    ...
    if (getInfo("Request.templatemode") == "Read") {
        ...
        if (formJson.Request.mode == "DRAFT" || formJson.Request.mode == "TEMPSAVE") {
            ...
            if (CFN_GetQueryString("RequestFormInstID") != "undefined") {
				...
				$('input[name="JobDate"]').prop('disabled', true); // 날짜 변경 불가
				getOvertimeWorkData();
			}else{
				formTitle = "연장근무 신청서";
