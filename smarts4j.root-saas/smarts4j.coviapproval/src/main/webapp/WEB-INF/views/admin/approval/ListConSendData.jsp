...
<script type="text/javascript">
	...
	// 헤더 설정
	var headerData =[	            
	                  {key:'IDX', label:'순번', width:'50', align:'center', sort:"asc"},
	                  {key:'DocID',  label:'FormInstID', width:'100', align:'center'},	                  
	                  {key:'SystemID',  label:'연동시스템', width:'100', align:'center'},
	                  {key:'FMPF', label:'FORM PREFIX', width:'150', align:'center'},
	                  {key:'FormName',  label:'양식명', width:'150', align:'center'},
	                  {key:'Subject',  label:'제목', width:'200', align:'left'},	                  
	                  {key:'ApvResult',  label:'결재상태', width:'100', align:'center'},
	                  {key:'ExDisplayName', label:'기안자', width:'100', align:'center'},
	                  {key:'DocNumber',  label:'문서번호', width:'100', align:'center'},
	                  {key:'SendDate', label:'보낸시간', width:'150', align:'center'}	                  
		      		];
	...
	function searchConfig(flag){
		...
		myGrid.bindGrid({
				ajaxUrl:"admin/getConSendDataLogLegacy.do",
				ajaxPars: {					
...
<h3 class="con_tit_box">
	<span class="con_tit">연동시스템 송신로그</span>	
</h3>
<form id="form1">
		...
		<div id="topitembar02" class="topbar_grid">
			...
			<label>	
				...
				<select class="AXSelect" name="sel_Search" id="sel_Search" >
                	...
                	<option value="A.SystemID">연동시스템</option>
	                <option value='A.DocID' >FormInstID</option>
	                <option value='A.FMPF' >FormPrefix</option>
	                <option value='B.UR_Name' >기안자</option>
	                <option value='A.FormName' >양식명</option>
	                <option value='A.Subject' >제목</option>
	                <option value='A.BODYCONTEXT'>본문</option>	
				</select>	
