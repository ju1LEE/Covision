...
<body>
	<h3 class="con_tit_box">
		<span class="con_tit"><spring:message code='Cache.CN_106' /></span> <!-- 미결함 -->
<!-- 		[<span id="approvalCnt" style="color: red"></span>] -->
	</h3>
	<form id="form1">
		<div id="topitembar01" class="topbar_grid">
			<input type="button" value="<spring:message code='Cache.btn_UserAdd' />" onclick="OrgMap_Open(0);" class="AXButton"/>	<!-- 사용자선택 -->
