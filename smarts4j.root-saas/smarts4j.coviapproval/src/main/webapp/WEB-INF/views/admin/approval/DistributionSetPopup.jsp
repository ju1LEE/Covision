...
<form id="GroupListSetPopup.jsp" name="GroupListSetPopup.jsp">
	<div>		 		
		<table class="AXFormTable" >
		  ...
		  <tbody>
		    <tr>
		      <th style="width:100px;"><spring:message code="Cache.lbl_apv_grform_01"/></th>
			  <td><input id="GroupName" name="GroupName" type="text" class="AXInput" maxlength="64" style="width:350px;"/></td>
		    </tr>
		    <tr>
		      <th style="width:100px;"><spring:message code="Cache.lbl_apv_grform_02"/></th>
			  <td><input id="GroupCode" name="GroupCode" type="text" class="AXInput" maxlength="64" style="width:350px;"/></td>
		    </tr>
			<tr>
		      <th style="width:100px;"><spring:message code="Cache.lbl_apv_grform_03"/></th>
			  <td><textarea id="Description" name="Description" class="AXTextarea" maxlength="512" style="width:340px; height:50px; overflow:scroll; overflow-x:hidden;resize:none;"></textarea></td>
		    </tr>
			<tr>
		      <th style="width:100px;"><spring:message code="Cache.lbl_apv_Sort"/></th>
			  <td><input mode="numberint"  num_max="32767" class="AXInput"   id="SortKey" name="SortKey" type="text" maxlength="16" style="width:350px;"/></td>
		    </tr>		    
			<tr>
		      <th style="width:100px;"><spring:message code="Cache.lbl_apv_grform_05"/></th>
                <td>
			...
			<tr>
		      <th style="width: 85px ;"><spring:message code="Cache.lbl_apv_grform_06"/></th>
			  <td><input id="InsertDate" name="InsertDate" type="text" readonly="readonly" class="AXInput" style="width:350px;"></td>
		    </tr>
		    </c:if>
	      </tbody>
