...
<form id="form1">
  <div class="popContent vmExcelUploadPopup" style="padding: 0px 24px 30px;">
	  <div class="top" style="margin-top: 20px;">
	    <strong style="font-size: 17px;"><spring:message code='Cache.apv_btn_rule'/> <spring:message code='Cache.lbl_versionCont'/></strong>  <!-- 전결규정 버전관리 -->
	    <div class="ulList type02 mt20">
			<div id="topitembar02" class="topbar_grid">			
				...
				<input name="search" type="text" id="search" onkeypress="if (event.keyCode==13){ searchConfig(); return false;}" class="AXInput" style="display:none"/>	
				<span id="divDate" style="display:none">
...
<script type="text/javascript">
	...
	function searchConfig(){		
		...
		bizRuleGrid.bindGrid({
				ajaxUrl:"/approval/admin/getRulHisotryList.do",
				ajaxPars: {
	...
	function updateConfig(vernum){
		Common.open("","updatebaseconfig","전결규정 버전관리 상세화면","/approval/admin/goRuleHisotrySetPopup.do?mode=modify&key="+vernum,"550px","350px","iframe",false,null,null,true);
	}
