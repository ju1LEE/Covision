	...
	$.ajax({
		...
		success:function (data) {
			if(data != null && data != undefined){
				$("#INITIATOR_NAME").html(data.list[0].InitiatorName); //작성자
...
<div>
	<div align="left">
		<input type="button" class="AXButton BtnRefresh" value="<spring:message code='Cache.btn_apv_refresh'/>" onclick="refresh()"/> <!-- 새로고침 -->
		<input type="button" id="btn_markingRollBack" class="AXButton" value="<spring:message code="Cache.lbl_apv_rollback_doc"/>" onclick="markingRollBack();" style="display:none"/> <!-- 문서 복원 -->
		<input type="button" id="btn_delMarking" class="AXButton" value="<spring:message code="Cache.lbl_apv_delete_marking"/>" onclick="deleteMarkingDel();"/> <!-- 문서 삭제마킹 -->
		<input type="button" id="btn_allDelete" class="AXButton" value="<spring:message code="Cache.lbl_apv_deleted_doc"/>" onclick="deleteClearDel();"/> <!-- 문서 완전 삭제 -->
	</div>
	<div style="margin-top: 10px">
		<table class="AXFormTable">
			<tr>
				...
				<th width="10%" >작성일자</th>
				<td width="15%" > <span id="INITIATE_DATE"></span></td>
				<th width="10%" >상태</th>
				<td width="15%" > <font color="red"><span id="STATE" style="font-weight:bold;"></span></font></td>
			</tr>
		</table>
	</div>
    <div style="margin-top: 10px; margin-bottom: 10px">
          <table class="AXFormTable">
            ...
            <table class="AXFormTable" align="center">
            	<colgroup>
            		<col style="width: 10%">
            		<col width ="80%">
            		<col width ="10%">
