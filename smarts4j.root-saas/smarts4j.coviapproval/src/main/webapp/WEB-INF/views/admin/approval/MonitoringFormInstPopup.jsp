	...
	function saveFormInst(obj){
		...
		$("#tblFormInstance").find("td").find("input[type=text],textarea").each(function(){
			if($(this).attr("readonly") != "readonly")
				$$(dataJson).append($(this).attr("id").replace("txt_", ""), $(this).val());
		});
    	...
    	<table id="tblFormInstance" class="AXFormTable" width="100%">
    		...
    		<tbody>
				...
				<tr>
					...
					<td colspan="3"><textarea id="txt_AttachFileInfo" rows="2"  style="width:95%;padding:3px;resize:none;border: 0" readonly></textarea></td>				
				</tr>
				<tr>
					<th>SaveTerm</th>
				...
				<tr>
					<th>BodyContext</th>
					<td colspan="3"><textarea id="txt_BodyContext" rows="2" style="width:95%;padding:3px;resize:none;border:0" readonly></textarea></td>
				</tr>
    		</tbody>
    	</table>
    	<br/>
