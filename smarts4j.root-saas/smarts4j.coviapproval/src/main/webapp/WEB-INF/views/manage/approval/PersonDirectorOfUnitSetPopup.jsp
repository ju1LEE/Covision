		...
		<table class="sadmin_table sa_menuBasicSetting mb20">
			...
			<tr>
				...
				<td>
					...
					<a href="#" class="btnTypeDefault" onclick="OrgMap_Open(0);"><spring:message code='Cache.lbl_apv_selection'/></a> <!-- 사용자 선택 -->
				</td>
			</tr>
			<tr>
				<th><spring:message code='Cache.lbl_Auth_Duration'/></th>
				<td>
					<input type="text" id="AUTH_START" style="width: 105px;" class="" />
					~
					<input type="text" kind="twindate" date_startTargetID="AUTH_START" id="AUTH_END" style="width: 105px;" class="" />
				</td>
			</tr>
