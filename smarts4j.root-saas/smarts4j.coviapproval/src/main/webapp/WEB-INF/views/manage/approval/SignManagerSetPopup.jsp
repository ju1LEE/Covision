				 ...
				 $.ajax({
					 ...
					 success : function(data){
						 if(data.status==="SUCCESS"){
			            	Common.Inform("<spring:message code='Cache.msg_insert'/>","",function(){
...
<form id="SignManagerSetPopup" name="SignManagerSetPopup"  method="post" enctype="multipart/form-data">
	<div class="sadmin_pop" >
		<table class="sadmin_table sa_menuBasicSetting mb20" >     
			...
			<tbody>
				<tr>
					<td class="" style="text-align: center;height: 103px;">
			        ...
			        <td class="" style="border-right:0px;">
			     		<input name="fileurl" id="fileurl" type="text" readonly="readonly" style="width:115%;">				            
			        </td>
			        <td class="" align="center">
			        	<a href="#" class="btnTypeDefault" onclick="document.getElementById('MyFile').click();"><spring:message code='Cache.lbl_apv_sign'/><spring:message code='Cache.btn_apv_register'/></a>			        
                            <!--서명등록-->                         
