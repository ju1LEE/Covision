...
<script type="text/javascript">
	...
	BizDocMemberGrid.config.fitToWidthRightMargin = 0;
	...
	function searchConfig(flag){
		BizDocMemberGrid.page.pageNo = "1";
...
// 					$("#sel_Search").bindSelect();
	...
	function updateConfig(pModal, configkey){		
		Common.open("","updateConfig","<spring:message code='Cache.lbl_apv_BizDocManage'/>|||<spring:message code='Cache.lbl_apv_charge_person'/>","goBizDocMemberDetailPopup.do?mode=modify&key="+configkey,"530px","300px","iframe",pModal,null,null,true);
	}
...
<div class="sadmin_pop sadminContent">
	...
	<div id="BizDocMembergrid" class="tblList tblCont"></div>
</div>
