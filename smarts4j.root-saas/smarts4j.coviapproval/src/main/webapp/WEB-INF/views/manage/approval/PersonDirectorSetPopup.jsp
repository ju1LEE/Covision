...
<script  type="text/javascript">
	...
	function addDataRow(pCode, pName, pViewStartDate, pViewEndDate) {
		if(pCode && pName) {
			...
			sHTML += "	<td style='text-align: center; word-break: break-all;'><span>" + pCode + "</span><input type='hidden' name='hidden_PERSON_CODE' id='hidden_PERSON_CODE_" + XFN_ReplaceAllSpecialChars(pCode) + "' value='" + pCode + "'></td>";
...
<form id="PersonDirectorOfUnitSetPopup" name="PersonDirectorOfUnitSetPopup">
	<div class="sadmin_pop">
		<table class="sadmin_table sa_menuBasicSetting mb20">
			...
			<tr>
				<th><spring:message code='Cache.lbl_Specific_User'/></th>
				<td>
						...
						<table class="" style="border-top:1px solid #bbb;">
							...
							<thead>								
								<tr style="height: 38px;">
									<th style=""></th>
									<th style="text-align: center; padding: 5px;"><spring:message code="Cache.lbl_USER_NAME_01"/></th>
									<th style="text-align: center; padding: 5px;"><spring:message code="Cache.lbl_UserCode"/></th>
			...
			<tr style="display: none;"><!-- 쿼리 작업 후 사용-->
				...
				<td>
					...
					<input type="text" id="SEARCH_START" style="width: 105px" class="" />
					~ 
					<input type="text" kind="twindate" date_startTargetID="SEARCH_START" id="SEARCH_END" style="width: 105px" class="" />
				</td>
			</tr>
			<tr>
		...
		<div class="collabo_help">
			<p><spring:message code='Cache.msg_apv_UserDocAuthorityScope'/></p> <!-- 대상 사용자 개인함의 완료함, 참조/회람함에 대하여 조회 권한을 부여합니다. -->
