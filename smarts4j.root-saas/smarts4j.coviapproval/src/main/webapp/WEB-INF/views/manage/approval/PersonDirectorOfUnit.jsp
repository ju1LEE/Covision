...
<div class="cRConTop titType AtnTop">
	<h2 class="title">
		<span><spring:message code="Cache.lbl_targetDeptUser"/></span> 
	</h2>
</div>
...
<script type="text/javascript">
	...
	function searchConfig(){
		...
		myGrid.bindGrid({
 			ajaxUrl:"/approval/manage/getPersonDirectorOfUnitList.do",
 			ajaxPars: {
	...
	function addAuthority(pModal){
		...
		objPopup = parent.Common.open("","addAuthority","<spring:message code='Cache.lbl_addAuthority'/>|||<spring:message code='Cache.lbl_apv_Specific_User_Manage'/>","/approval/manage/goPersonDirectorOfUnitSetPopup.do?mode=add&paramEntCode="+paramEntCode,"700px","650px","iframe",pModal,null,null,true);
	...
	function updateAuthority(pModal, configkey){	
		var paramEntCode = $("#hidden_useAuthority_val").val();
		objPopup = parent.Common.open("","updateAuthority","<spring:message code='Cache.lbl_updateAuthority'/>|||<spring:message code='Cache.lbl_apv_Specific_User_Manage'/>","/approval/manage/goPersonDirectorOfUnitSetPopup.do?mode=modify&paramEntCode="+paramEntCode+"&key="+configkey,"700px","650px","iframe",pModal,null,null,true);
	}
