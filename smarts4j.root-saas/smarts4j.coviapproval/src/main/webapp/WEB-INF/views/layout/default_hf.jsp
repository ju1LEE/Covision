...
<!-- css block -->
<link rel="stylesheet" type="text/css" href="<c:url value='../covicore/css/axisj/arongi/AXJ.css'/>" />
<link rel="stylesheet" type="text/css" href="<c:url value='../covicore/css/axicon/axicon.min.css'/>" />
<!-- js block -->
