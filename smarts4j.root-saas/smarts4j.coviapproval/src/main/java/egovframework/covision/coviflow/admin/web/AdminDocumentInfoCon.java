...
@Controller
public class AdminDocumentInfoCon {

	@Autowired
	private AuthHelper authHelper;

	private Logger LOGGER = LogManager.getLogger(AdminDocumentInfoCon.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/updateDocData.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/deleteMarkingDel.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/markingRollBack.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/deleteClearDel.do", method = {RequestMethod.GET,RequestMethod.POST})
