...
@Controller
public class JobFunctionCon {
	@Autowired
	private AuthHelper authHelper;
	
	private Logger LOGGER = LogManager.getLogger(JobFunctionCon.class);
	 ...
	 */
	@RequestMapping(value = "admin/getJobFunctionList.do", method=RequestMethod.POST)
	 ...
	 * @throws Exception tempSaveDoc
	 */
	@RequestMapping(value = "admin/getJobFunctionMemberList.do", method=RequestMethod.POST)
	...
	@RequestMapping(value = "admin/getJobFunctionMemberAllList.do", method=RequestMethod.POST)
	public @ResponseBody CoviMap getJobFunctionMemberALLList(HttpServletRequest request, HttpServletResponse response,@RequestParam Map<String, String> paramMap) throws Exception
	{
		CoviMap returnList = new CoviMap();
		...
		try {
			...
			resultList = jobFunctionSvc.selectJobFunctionAllMember(params);
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "admin/goJobFunctionSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goPersonDirectorOfUnitSetPopup(Locale locale, Model model) {		
		String returnURL = "admin/approval/JobFunctionSetPopup";		
	 ...
	 */
	@RequestMapping(value = "admin/goJobFunctionMember.do", method = RequestMethod.GET)
	public ModelAndView goBizDocMember() {
		String returnURL = "admin/approval/JobFunctionMember";		
		return new ModelAndView(returnURL);
	}
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "admin/goJobFunctionMemberSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goJobFunctionMemberSetPopup(Locale locale, Model model) {		
		String returnURL = "admin/approval/JobFunctionMemberSetPopup";		
		return new ModelAndView(returnURL);
	}
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "admin/goJobFunctionMemberDetailPopup.do", method = RequestMethod.GET)
	public ModelAndView goJobFunctionMemberDetailPopup(Locale locale, Model model) {
		String returnURL = "admin/approval/JobFunctionMemberDetailPopup";		
		return new ModelAndView(returnURL);
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/getJobFunctionData.do", method=RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/getJobFunctionMemberData.do", method=RequestMethod.POST)
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/insertJobFunction.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/updateJobFunction.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/deleteJobFunction.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/insertJobFunctionMember.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/updateJobFunctionMember.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/deleteJobFunctionMember.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
