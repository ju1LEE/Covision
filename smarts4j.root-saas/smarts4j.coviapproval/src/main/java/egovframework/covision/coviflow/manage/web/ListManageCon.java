...
@Controller
public class ListManageCon {

	private Logger LOGGER = LogManager.getLogger(ListManageCon.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/OpenDocumentInfoPopup.do", method = RequestMethod.GET)
	public @ResponseBody ModelAndView getUserFolderListData(Locale locale, Model model)
	{
		String returnURL = "manage/approval/OpenDocumentInfoPopup";
		return new ModelAndView(returnURL);
	}

	//오류관리 - 연동오류처리 - JSON수정팝업
	@RequestMapping(value = "manage/OpenJsonEditPopup.do", method = RequestMethod.GET)
	public @ResponseBody ModelAndView getOpenJsonEditPopup(Locale locale, Model model)
	{
		String returnURL = "manage/approval/OpenJsonEditPopup";
		return new ModelAndView(returnURL);
	}
	
	//오류관리 - 개별연동오류처리 - 결과 상세보기
	@RequestMapping(value = "manage/OpenLegacyResultPopup.do", method = RequestMethod.GET)
	public @ResponseBody ModelAndView getLegacyResultPopup(Locale locale, Model model)
	{
		String returnURL = "manage/approval/OpenLegacyResultPopup";
		return new ModelAndView(returnURL);
	}
	
	//오류관리 - 개별연동오류처리 - 재처리요청(파라미터)
	@RequestMapping(value = "manage/OpenLegacyParamPopup.do", method = RequestMethod.GET)
	public @ResponseBody ModelAndView getLegacyParamPopup(Locale locale, Model model)
	{
		String returnURL = "manage/approval/OpenLegacyParamPopup";
		return new ModelAndView(returnURL);
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/getEntinfototalListData.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/getListAdminData.do", method = RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/setDocumentInfo.do", method = RequestMethod.POST)
