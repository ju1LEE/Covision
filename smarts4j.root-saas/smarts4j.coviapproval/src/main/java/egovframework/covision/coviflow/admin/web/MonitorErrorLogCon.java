...
@Controller
public class MonitorErrorLogCon {
	@Autowired
	private AuthHelper authHelper;
	
	private Logger LOGGER = LogManager.getLogger(MonitorErrorLogCon.class);
	 ...
	 */
	@RequestMapping(value = "admin/getMonitorErrorLog.do", method=RequestMethod.POST)
	...
	@RequestMapping(value = "admin/deleteErrorLog.do", method=RequestMethod.POST)
