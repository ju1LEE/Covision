...
@Controller
public class DistributionListCon {
	@Autowired
	private AuthHelper authHelper;
	
	private Logger LOGGER = LogManager.getLogger(DistributionListCon.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/getDistributionList.do", method=RequestMethod.POST)
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "admin/goDistributionListSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goDistributionListSetPopup(Locale locale, Model model) {		
		String returnURL = "admin/approval/DistributionSetPopup";		
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/insertDistributionList.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/updateDistribution.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/deleteDistribution.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/getDistirbutionData.do", method=RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/getDistributionMemberList.do", method=RequestMethod.POST)
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "admin/goDistributionMemberSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goDistributionMemberSetPopup(Locale locale, Model model) {		
		String returnURL = "admin/approval/DistributionMemberSetPopup";		
		return new ModelAndView(returnURL);
	}
	/**
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/insertDistributionMember.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/updateDistributionMember.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/deleteDistributionMember.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/getDistributionMemberData.do", method=RequestMethod.POST)
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "admin/goDistributionMemberDetailPopup.do", method = RequestMethod.GET)
	public ModelAndView goDistributionMemberDetailPopup(Locale locale, Model model) {		
		String returnURL = "admin/approval/DistributionMemberDetailPopup";		
		return new ModelAndView(returnURL);
	}
}
