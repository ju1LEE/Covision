...
@Controller
public class DocReadConfirmCon {
	@Autowired
	private AuthHelper authHelper;
	
	private Logger LOGGER = LogManager.getLogger(DocReadConfirmCon.class);
	 ...
	 */
	@RequestMapping(value = "admin/getDocReadConfirmList.do", method=RequestMethod.POST)
