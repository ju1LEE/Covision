...
public class FormManageCon {
	...
	private Logger LOGGER = LogManager.getLogger(FormManageCon.class);
	 ...
	 */
	@RequestMapping(value = "manage/getAdminFormListData.do", method=RequestMethod.POST)
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "manage/goAdminFormPopup.do", method = RequestMethod.GET)
	public ModelAndView goAdminFormPopup(Locale locale, Model model) {		
		String returnURL = "manage/approval/AdminFormPopup";
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "manage/goAdminFormDocEditor.do", method = RequestMethod.GET)
	public ModelAndView goAdminFormDocEditor(Locale locale, Model model) {		
		String returnURL = "manage/approval/AdminFormDocEditor";		
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/getAdminFormData.do", method=RequestMethod.POST)
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "manage/insertAdminFormData.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	public @ResponseBody CoviMap insertAdminFormData(HttpServletRequest request, HttpServletResponse response,@RequestParam Map<String, String> paramMap) throws Exception
	{
		...
		try {
            ...
            if(StringUtil.isNotNull(sourcefile)){            	
            	fileCopy(sourcefile,fileName, FileUtil.checkTraversalCharacter(companyCode), orgFileEntCode);
            }else{
            	if(extInfoObj.has("FormCreateKind") && extInfoObj.optString("FormCreateKind").equals("1")) { // 신규만들기 일 때만 타도록 수정
	            	if(extInfoObj.has("UseEditYN") && extInfoObj.optString("UseEditYN").equalsIgnoreCase("Y")){ //웹에디터 사용
	            		...
	            		fileCopy("default/JWF_Form_Default.html",fileName, FileUtil.checkTraversalCharacter(companyCode), orgFileEntCode);
	            	}
            	}
            }
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "manage/updateAdminFormData.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "manage/deleteAdminFormData.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/getFormClassListSelectData.do", method=RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/getSchemaListSelectData.do", method=RequestMethod.POST)
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "manage/goFormFileList.do", method = RequestMethod.GET)
	public ModelAndView goFormFileList(Locale locale, Model model) {		
		String returnURL = "manage/approval/FormFileList";		
		return new ModelAndView(returnURL);
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/getFormFileList.do", method=RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/getAutoApprovalLineDeptlist.do", method=RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/getAutoApprovalLineRegionlist.do", method=RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/checkDuplidationTableName.do", method=RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/addFormDuplicateCheck.do", method=RequestMethod.POST)
	...
	public void fileCopy(String originalfile, String newfile, String getCompanyCode, String getOrgFileEntCode){
		...
		try(
			FileInputStream fis = new FileInputStream(filePath+originalfile);
			FileOutputStream fos = new FileOutputStream(companyPath+newfile);
		) {
			int data = 0;
