...
@Controller
public class MonthlyTrendCompManageCon {
	@Autowired
	private AuthHelper authHelper;
	
	private Logger LOGGER = LogManager.getLogger(MonthlyTrendCompManageCon.class);
	 ...
	 */
	@RequestMapping(value = "manage/getMonthlyDeptList.do", method=RequestMethod.POST)
	 ...
	 * @throws Exception tempSaveDoc
	 */
	@RequestMapping(value = "manage/getMonthlyFormList.do", method=RequestMethod.POST)
	 ...
	 * @throws Exception tempSaveDoc
	 */
	@RequestMapping(value = "manage/getMonthlyPersonList.do", method=RequestMethod.POST)
	...
	// 엑셀 다운로드
	@RequestMapping(value = "manage/monthlyTrendComparisonExcelDownload.do" , method = RequestMethod.GET)
