...
@Controller
public class DeptDocTransferCon {
	@Autowired
	private AuthHelper authHelper;
	
	private Logger LOGGER = LogManager.getLogger(DeptDocTransferCon.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/getDeptDocTransferCount.do", method=RequestMethod.POST)
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "admin/transferDeptDoc.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
