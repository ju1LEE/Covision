...
public class CoviMapperLegacy{
	
}

//JTA(Transaction) 사용시 아래 설정
/*
@Repository("coviMapperLegacy")
public class CoviMapperLegacy extends EgovAbstractMapper implements CoviCommonRepository {
	
	@Resource(name = "sqlSessionLegacy")
