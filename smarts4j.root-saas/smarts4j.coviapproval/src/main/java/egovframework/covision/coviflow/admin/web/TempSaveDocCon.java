...
@Controller
public class TempSaveDocCon {
	@Autowired
	private AuthHelper authHelper;
	
	private Logger LOGGER = LogManager.getLogger(TempSaveDocCon.class);
	 ...
	 */
	@RequestMapping(value = "admin/getTempSaveDocList.do", method=RequestMethod.POST)
