...
@Controller
public class FormClassManageCon {
	@Autowired
	private AuthHelper authHelper;
	
	private Logger LOGGER = LogManager.getLogger(FormClassManageCon.class);
	 ...
	 */
	@RequestMapping(value = "manage/getFormClassList.do", method=RequestMethod.POST)
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "manage/goFormClassPopup.do", method = RequestMethod.GET)
	public ModelAndView goFormClassPopup(Locale locale, Model model) {		
		String returnURL = "manage/approval/FormClassPopup";		
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/getFormClassData.do", method=RequestMethod.POST)
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "manage/insertFormClassData.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "manage/updateFormClassData.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "manage/deleteFormClassData.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
