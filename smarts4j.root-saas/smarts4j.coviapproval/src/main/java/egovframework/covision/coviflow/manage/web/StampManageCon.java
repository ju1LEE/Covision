...
@Controller
public class StampManageCon {
	
	private Logger LOGGER = LogManager.getLogger(StampManageCon.class);
	 ...
	 */
	@RequestMapping(value = "manage/getStampList.do", method=RequestMethod.POST)
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "manage/goStampManagerSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goStampManagerSetPopup(Locale locale, Model model) {
		String returnURL = "manage/approval/StampManagerSetPopup";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "manage/getStampData.do", method=RequestMethod.POST)
	 ...
	 */	
	@RequestMapping(value = "manage/insertStampData.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return CoviMap CoviMap
	 */	
	@RequestMapping(value = "manage/updateStampData.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	...
	@RequestMapping(value = "manage/deleteStampData.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "manage/setUseStampUse.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
