<%@ page language="java" contentType="text/html; charset=UTF-8"	pageEncoding="UTF-8" import="egovframework.coviframework.util.ComUtils"%>
...
<div>
	<div class="topHead">
		<ul class="tabMenuArrow  clearFloat">
			<li class="active" type="Mail"><a><spring:message code='Cache.lbl_MAIL'/></a></li>
			<li class="" type="Approval"><a><spring:message code='Cache.lbl_apv_app'/></a></li>
			<li class="" type="Schedule"><a><spring:message code='Cache.lbl_Schedule'/></a></li>
			<li class="" type="Resource"><a><spring:message code='Cache.lbl_Reservation'/></a></li>
			<li class="" type="Board"><a><spring:message code='Cache.lbl_Post'/></a></li>
		</ul>
		<a class="btnOrderContClose">닫기</a>
	</div>
	<div class="middleCont">
		<div id="mailSimpleMake" class="tabContentArrow active">							
		...
		<script>
			...
			function initSimpleMake(moduleName){
				if(moduleName == "Mail" && isLoad["Mail"] == false){
					coviCtrl.setCustomAjaxAutoTags('myAutocompleteMultiple', '/covicore/control/getAllUserAutoTagList.do', {
						labelKey : 'UserName',
						valueKey : 'UserCode',
						minLength : 1,
						useEnter : false,
			...
			function clickSimpleMakeTap(obj){
				...
				$(obj).addClass('active');
				$('.tabContentArrow').eq($(obj).index()).addClass('active');
			}
		...
		<div id="resourceSimpleMake" class="tabContentArrow">
			...
			function setDateConResource(){
				...
				coviCtrl.setSelected('simpleResDateCon [name=startHour]', AddFrontZero(nowHour, 2));
				coviCtrl.setSelected('simpleResDateCon [name=startMinute]', nowMinite);
				
				nowHour = new Date();
				nowHour.setTime(new Date().getTime() + (60*60*1000));
		...
		<div id="boardSimpleMake" class="tabContentArrow">							
			...
			<div class="bottomCont">
				...
				<a id="btnBoardWrite" class="btnTypeDefault btnTypeChk ml5"><spring:message code='Cache.btn_register'/></a>			<!-- 등록 -->
			</div>
