...
<div data-role="page" id="schedule_week_page" class="mob_rw">

	<header data-role="header" id="schedule_week_header">
        ...
        <div class="l_header">
          ...
          <div class="menu_link gnb">
          	<span id="schedule_week_title" href="javascript:void(0);" class="topH_tit"><spring:message code='Cache.lbl_weeklyShow' /></span>
			<div class="cover_leftmenu" style="display:none;">
				...
				<div class="sorting">				             
					<ul>
						...
						<li class="selected"  name="schedulemenu"><a class="weekly" href="javascript: mobile_schedule_changeCalendar('W');"><spring:message code='Cache.lbl_Weekly' /></a></li> <!-- 주간보기 -->						
	...
	<div data-role="content" class="cont_wrap" id="schedule_week_content">
		<div class="calendar_wrap week">
			<div class="calendar_ctrl">
				<div class="month_ctrl">
					...
					<p id="schedule_week_titleDate" class="t_month"></p>
					<a href="javascript: mobile_schedule_ShowPrevNextCalendar('next');" class="next_month"></a>
				</div>
				<a href="javascript: mobile_schedule_WeekInit();" class="btn_today"><spring:message code='Cache.btn_Today' /></a> <!-- 오늘 -->
			</div>
			<div class="slide_bar">
				<span class="slide_color" id="sSlide_bar">바</span>
			</div>
			<div id="schedule_week_calendar" class="week_schedule">
				<table>
					<colgroup>
					...
					<thead>
						<tr id="schedule_week_calendarheader"></tr>
					</thead>
				</table>
			</div>
			<div class="week_schedule scr">
				<table>
					<colgroup>
						<col style="width: 10px;">
						<col style="width: 52px;">
					...
					<tbody id="schedule_week_calendarbody"></tbody>
				</table>
			</div>
		</div>
		<ul id="schedule_week_list" class="schedule_list" style="height: calc(100% - 278px);"></ul>
	</div>
