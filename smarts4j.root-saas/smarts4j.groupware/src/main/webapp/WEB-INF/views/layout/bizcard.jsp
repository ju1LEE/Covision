  ...
  <head>
    ...
    <style>
    	* { 
    	...
    	.ulBizCardMenuList input[type=button] {
    		text-align: center; 
    		width: 95%; 
    		background-color: rgba(65, 157, 232, 0.9); 
    		color: white; 
    		margin-bottom: 5px;
    	}
    	
    	.liBizCardMenuListBorder {
    		border-top : 1px solid #d9d9d9;
    	}
    	
    	.ulBizCardGroupList > li {
    		min-height: 25px;
    		line-height: 25px;
    ...
    <script>
    	$(window).load(function() {
    		$("menuDrawBox").css("height", $("section").css('height'));
   		});
    </script>
  </head>
