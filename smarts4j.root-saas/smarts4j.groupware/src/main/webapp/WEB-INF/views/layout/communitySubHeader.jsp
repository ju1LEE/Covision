...
function setSubHeader(){
	 $.ajax({
		url:"/groupware/layout/userCommunity/communitySubHeaderSetting.do",
		type:"POST",
		async:true,
		data:{
			communityID : cID
		...
		error:function(response, status, error){
			CFN_ErrorAjax("/groupware/layout/userCommunity/communitySubHeaderSetting.do", response, status, error); 
		}
	}); 
}
