...
<form id="form1">
    <div>
    	 <table class="AXFormTable">
    	 	...
    	 	<tbody>
    	 		<tr> 
    	 			...
    	 			<td>
	    	 			<input type="text"  id="txtAttributeName" class="AXInput" style="width: 70%;"/>&nbsp;
    	 		...
    	 		<tr>
    	 			...
    	 			<td>
    	 				<input type="text"  id="txtAttributeValue" class="AXInput" style="width: 70%;"/>&nbsp;
		 ...
		 <div class="pop_btn2" align="center" style="margin-top:15px;">
	     	<input type="button" value="<spring:message code='Cache.btn_apv_save'/>" onclick="returnAttribute();" class="AXButton red" />
