...
<script type="text/javascript">
	...
	var leftdata = ${adminorgmanageleft};
	...
	function leftmenu_goToPageMain(){
		location.href = "/covicore/organization_organizationadminhome.do";
	}
...
<nav class="lnb">
	<h2 class="gnb_left_tit"><span class="gnb_tit" onclick="leftmenu_goToPageMain(); return false"><spring:message code="Cache.CN_144" /></span></h2>
	<div>
		<label>
