package egovframework.covision.groupware.resource.admin.web;
...
import egovframework.covision.groupware.resource.admin.service.ResourceManageSvc;


@Controller
public class ResourceManageCon {
	...
	@Autowired
	private ResourceManageSvc resourceManageSvc;
	
	@Autowired
	AuthorityService authSvc;
	
	private Logger LOGGER = LogManager.getLogger(ResourceManageCon.class); 
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/getLeftDefaultData.do", method =  {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getEquipmentList.do" , method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/chnageEquipmentIsUse.do", method = RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/deleteEquipmentData.do", method = RequestMethod.POST)
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "resource/goEquipmentManageSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goEquipmentManageSetPopup() {
		String returnURL = "admin/resource/EquipmentManageSetPopup";
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "resource/saveEquipmentData.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @return mav
	 */	
	@RequestMapping(value = "resource/modifyEquipmentData.do", method = {RequestMethod.GET,RequestMethod.POST}, produces = "application/json;charset=UTF-8")	
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getEquipmentData.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getMainResourceList.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getMainResourceTreeList.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getFolderResourceTreeList.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getOnlyFolderTreeList.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "resource/goResourceTreePopup.do", method = RequestMethod.GET)
	public ModelAndView goResourceTreePopup() {
		String returnURL = "admin/resource/ResourceTree";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/insertMainResourceList.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/changeResourceSortKey.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getFolderInfo.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getFolderList.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getBookingOfResourceList.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getResourceOfFolderList.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/changeIsSwitch.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/deleteFolderData.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/changeFolderSortKey.do", method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "admin/moveFolderResource.do", method = RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/goResourceManageSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goLayoutManageSetPopup(HttpServletRequest request, Locale locale, Model model, @RequestParam Map<String, String> paramMap) {
		ModelAndView mav = new ModelAndView("admin/resource/ResourceManageSetPopup");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/goResourceManagePopup.do", method = RequestMethod.GET)
	public ModelAndView goResourceManagePopup(@RequestParam Map<String, String> paramMap) {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/selectResourceACLData.do", method = RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/getUserDefFieldGridList.do", method = RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/createUserDefField.do", method = RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/updateUserDefField.do", method = RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/getUserDefFieldOptionList.do", method = RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/deleteUserDefOption.do", method = RequestMethod.POST)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "resource/deleteUserDefField.do", method = RequestMethod.POST)
	...
	@RequestMapping(value = "resource/moveUserDefField.do", method = RequestMethod.POST)
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "resource/goFindParentFolder.do", method = RequestMethod.GET)
	public ModelAndView goFindParentFolder() {
		String returnURL = "admin/resource/ResourceFolderTree";
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "resource/goPlaceOfBusinessSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goPlaceOfBusinessSetPopup(HttpServletRequest request) throws Exception {
		...
		ModelAndView mav = new ModelAndView("admin/resource/PlaceOfBusinessSetPopup");
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "resource/goShareResourceListSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goShareResourceListSetPopup() {
		String returnURL = "admin/resource/ShareResourceListSetPopup";
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "resource/goResourceEquipmentSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goResourceEquipmentSetPopup() {
		String returnURL = "admin/resource/ResourceEquipmentSetPopup";
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "resource/goResourceAttributeSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goResourceAttributeSetPopup() {
		String returnURL = "admin/resource/ResourceAttributeSetPopup";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getShareResourceList.do" , method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @return mav
	 */
	@RequestMapping(value = "resource/goDisplayIconSetPopup.do", method = RequestMethod.GET)
	public ModelAndView goDisplayIconSetPopup() throws Exception {
		String returnURL = "admin/resource/DisplayIconSetPopup";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/saveFolderData.do", method = {RequestMethod.GET,RequestMethod.POST})
	public @ResponseBody CoviMap saveFolderData(   
		...
		try {
			...
			// 자원의 경우 menuID값을 0으로 입력(Not Null).
            if (folderDataObj.getString("folderType").toUpperCase().startsWith("RESOURCE")) {
                  folderDataObj.put("menuID", 0);
            }
            
            if ( folderDataObj.get("menuID") == null || folderDataObj.get("menuID").equals("")) {
                  folderDataObj.put("menuID", 0);
            }			
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/getFolderData.do" , method = {RequestMethod.GET,RequestMethod.POST})
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="resource/deleteBookingData.do" , method = {RequestMethod.GET,RequestMethod.POST})
	...
	/**
	 * selectDuplicateShareResource - 공유자원 중복 확인
	 * @param folderID, domainID
	 * @return returnList
	 * @throws Exception
	 */
	@RequestMapping(value="resource/checkDuplicateShareResource.do" , method = {RequestMethod.POST})
	public @ResponseBody CoviMap selectDuplicateShareResource(
				@RequestParam(value="folderID", required=true) String folderID
		...
		try {
			...
			returnList.put("cnt", resourceManageSvc.selectDuplicateShareResource(params));
			returnList.put("status", Return.SUCCESS);
		} catch(NullPointerException e) {
			returnList.put("status", Return.FAIL);
			returnList.put("message", isDevMode.equalsIgnoreCase("Y")?e.getMessage():DicHelper.getDic("msg_apv_030"));
