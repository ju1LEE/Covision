...
@Service("BoardNManageSvc")
public class BoardVManageImpl extends EgovAbstractServiceImpl implements BoardVManageSvc{
	...
	@Override
	public int updateBoardIsInherited(CoviMap params) throws Exception {
		return coviMapperOne.update("admin.board.updateBoardIsInherited", params);
	}
