...
public interface BoardVManageSvc {
	...
	int updateBoardIsInherited(CoviMap params) throws Exception;	//권한 상속여부 수정
	...
	CoviMap selectPrevNextField(CoviMap params) throws Exception; 		// 문서관리 > 문서번호관리
