package egovframework.covision.groupware.resource.admin.service;
...
public interface ResourceManageSvc {
	...
	int selectDuplicateShareResource(CoviMap params) throws Exception; 		// 공유 자원 중복 확인.
}
